...
while a:
    ...
    if (inp == 'rock' and ran == 1) or (inp == 'paper' and ran == 2) or (inp == 'scissor' and ran ==3):
        print('Nuk ka fitues')
        time.sleep(1.5)
        print('Ju keni fituar:',count_player,'herë, ndërsa kompjuteri:',count_pc,'herë')
        time.sleep(1)
        a = True
    elif (inp == 'rock' and ran == 3) or (inp == 'paper' and ran == 1) or (inp == 'scissor' and ran == 2):
        ...
        time.sleep(1)
        a = False
    elif (inp == 'rock' and ran == 2) or (inp == 'paper' and ran == 3) or (inp == 'scissor' and ran == 1):
    ...
    while b:
        ...
        if inp2 == 'po':
            ...
            a = True
            b = False
            ran = random.randint(1,3) # Ricaktoje doren e rradhes si rock,paper apo scissor
        elif inp2 == 'jo':
            a = False
            b = False
        else:
            print('Vetem vlerat po ose jo mund te pranohen si valide') # Nese inputi nuk eshte po ose jo, pyesim lojtarin perseri
            time.sleep(1)
